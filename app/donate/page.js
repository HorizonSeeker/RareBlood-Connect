...
import EmergencyServiceToggle from '@/components/EmergencyServiceToggle';
import { 
  MapPin, 
  Calendar, 
  Clock, 
    ...
    return (
      <div className="min-h-screen bg-[var(--background)] flex items-center justify-center">
        <div className="text-center">
          <div className="rounded-full h-16 w-16 border-4 border-red-200 border-t-red-600 mx-auto mb-4"></div>
          ...
          <div className="bg-[var(--card-background)] border-2 border-yellow-400 rounded-lg p-8 text-center">
            ...
            <p className="text-[var(--text-secondary)] mb-6">
              {verificationStatus === 'PENDING' 
                ? 'Your donor registration is currently under review by our admin team. We will verify your medical documents shortly. Once verified, you will be able to access all donation features.' 
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] transition-colors duration-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        {/* Emergency Service Toggle Section */}
                      ...
                      {!upcoming ? (
                        ...
                        >
                          {registering === drive._id ? (
                            <>
                              <div className="rounded-full h-4 w-4 border-2 border-white border-t-transparent mr-2"></div>
                              Registering...
                            </>
                          ) : (
                            <>
