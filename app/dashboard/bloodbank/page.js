      ...
      <div className="min-h-screen bg-[var(--background)] py-8">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="mb-8">
            ...
            <p className="text-[var(--text-secondary)]">Welcome back, Blood Bank Manager!</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-[var(--card-background)] p-6 rounded-lg border border-[var(--border-color)]">
            ...
            <div className="space-y-3">
              <Link href="/dashboard/bloodbank/inventory">
              ...
              <Link href="/dashboard/bloodbank/find-donors">
                <button className="w-full text-left p-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                  <div className="flex items-center">
                    <Users className="h-5 w-5 mr-3" />
                    <div>
                      <div className="font-medium">Find Nearby Donors</div>
                      <div className="text-sm opacity-90">Search donors by location & blood type</div>
                    </div>
                  </div>
                </button>
              </Link>
              
              <Link href="/dashboard/bloodbank/donors">
                <button className="w-full text-left p-4 bg-[var(--background)] border border-[var(--border-color)] rounded-lg hover:bg-[var(--card-background)] transition-colors">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-medium text-[var(--text-primary)]">View All Donors</div>
