...
const HospitalRegistrationPage = () => {
  ...
  React.useEffect(() => {
    ...
    // If user doesn't have hospital role, redirect to register role selection
    if (hasRole && userRole !== 'hospital') {
  ...
  return <RegistrationForm role="hospital" session={session} />;
};
