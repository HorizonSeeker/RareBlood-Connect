...
export default function Home() {
  ...
  // Redirect hospital users to their main dashboard
  useEffect(() => {
  ...
  return (
    <main className="bg-[var(--background)] transition-colors duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6 sm:space-y-8 md:space-y-10 md:col-span-7 lg:col-span-6">
              ...
              <div className="flex items-center space-x-2 mb-2 sm:mb-4 md:mb-6">
                ...
                <span className="font-heading text-xl sm:text-2xl lg:text-3xl font-bold">RareBlood Connect</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto pt-2">
                <Link href="/donation-request" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white text-[#ef4444] hover:bg-gray-100 
                  font-medium sm:font-semibold px-4 sm:px-5 md:px-6 lg:px-8 py-3 md:py-3.5 rounded-2xl transition-all">
                  <span className="mr-1 md:mr-2 text-lg">🩸</span>
              ...
              <div className="space-y-3 mt-2">
                ...
                <p className="text-xs sm:text-sm text-white/80 font-medium max-w-xs">Your regular donations keep our inventory ready for emergencies. Book a slot today!</p>
              </div>
            </div>
      ...
      {/* How RareBlood Connect Works Section */}
      <section className="py-12 sm:py-16 md:py-20 lg:py-24">
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 max-w-7xl">
          ...
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-lg sm:text-xl text-[var(--text-secondary)] max-w-3xl mx-auto">
              See how RareBlood Connect is transforming emergency response and saving lives
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="bg-gradient-to-br from-[#ef4444] to-[#ef4444]/90 rounded-xl p-6 sm:p-8 lg:p-10 text-white">
              ...
              <p className="text-white/90 mb-6 sm:mb-8 text-base sm:text-lg">
                Book your donation appointment and be the hero someone needs. Choose your preferred blood bank and time slot.
              </p>
              <Link href="/donation-request" className="inline-flex items-center justify-center bg-white text-[#ef4444] hover:bg-gray-100 font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-xl transition-all duration-300 group">
