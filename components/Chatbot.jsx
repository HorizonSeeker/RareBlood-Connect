  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      const welcomeMessage = {
        id: Date.now(),
        text: "Welcome to the RareBlood Connect assistant. I'm here to connect you to the people and information at RareBlood Connect that you need.\n\nTo help you connect with the right team members, please let us know the type of help you need.",
        isUser: false,
    ...
    return (
      <div className="fixed bottom-20 right-6 z-50 mb-2">
        <button
          ...
          aria-label="Open RareBlood Connect Assistant"
        >
          <MessageCircle className="w-6 h-6" />
          
          {/* Status indicator */}
          <div className="absolute -top-1 -right-1 w-3 h-3 bg-green-400 rounded-full shadow-lg"></div>
